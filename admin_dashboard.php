...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
    ...
    <nav class="bg-white shadow-lg p-6">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <!-- Tambahkan tombol Logout atau kontrol admin lainnya di sini -->
        </div>
    </nav>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <table id="visitorTable" class="stripe hover" style="width:100%;">
                ...
                <tbody>
                    ...
                    $sql = "SELECT ip_address, file_name, extracted_text FROM user_response";
        ...
        var visitorCounts = <?php
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    $visitorCounts[$month - 1] = $count; // Menggunakan index bulan (0-11) untuk mengisi array
                }
            }
